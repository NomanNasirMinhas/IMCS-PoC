...
export default function App({ navigation }) {
  ...
  const handleBarCodeScanned = async ({ type, data }) => {
    ...
    try {
      ...
      ///END
      // var vaccination = await fetch(
      //   `https://freighterapi.herokuapp.com/getMsgs/${parsedData.GovernmentID}&VACCINATION`
      // );
      // vaccination = await vaccination.json();

      // var test = await fetch(
      //   `https://freighterapi.herokuapp.com/getMsgs/${parsedData.GovernmentID}&COVIDTEST`
      // );
